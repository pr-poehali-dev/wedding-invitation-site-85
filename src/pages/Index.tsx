    ...
    <div className="min-h-screen bg-gradient-to-br from-[#6B5D56] via-[#8B7D76] to-[#A69589] py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr">
          ...
          {/* Hero Card */}
          <Card className="bg-[#2B2320] border-none shadow-2xl rounded-3xl overflow-hidden md:row-span-2">
            <CardContent className="p-0">
              ...
              <div className="p-8 text-center space-y-4">
                <h1 className="text-4xl font-light text-[#E8DDD0] tracking-widest" style={{ fontFamily: 'Cormorant, serif' }}>
                  ЮРИЙ<br />&<br />ЮЛИЯ
                </h1>
                <p className="text-xl text-[#C9B5A0] font-light" style={{ fontFamily: 'Cormorant, serif' }}>
                  06/07/2026
                </p>
              </div>
            </CardContent>
          ...
          {/* Welcome Card */}
          <Card className="bg-white border-none shadow-xl rounded-3xl lg:col-span-2">
            <CardContent className="p-8 space-y-6">
              ...
              <div className="text-center pt-4">
                <p className="text-sm text-[#8B7D76] font-light" style={{ fontFamily: 'Cormorant, serif' }}>
                  ИЮЛЬ 2025
                </p>
              </div>
                ...
                {calendarDays.map((day) => (
                  <div
                    ...
                    className={`text-center py-2 text-sm rounded-lg transition-all ${
                      day === 6
                        ? 'bg-[#2B2320] text-white font-bold relative'
                        : 'text-[#5C4F47] hover:bg-[#F5EDE0]'
                    }`}
                  >
                    {day}
                    {day === 6 && (
                      <Icon name="Heart" size={10} className="absolute -top-1 -right-1 fill-red-400 text-red-400" />
                    )}
                  </div>
                ))}
              </div>
          ...
          <Card className="bg-[#4A3832] border-none shadow-xl rounded-3xl">
            <CardContent className="p-6 space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-light text-[#E8DDD0] tracking-wider" style={{ fontFamily: 'Cormorant, serif' }}>
                  TIMING OF THE DAY
                </h3>
              </div>
          ...
          <Card className="bg-white border-none shadow-xl rounded-3xl lg:col-span-2">
            <CardContent className="p-8 space-y-6">
              ...
              <p className="text-sm text-[#5C4F47] text-center leading-relaxed max-w-xl mx-auto" style={{ fontFamily: 'Open Sans, sans-serif' }}>
          ...
          {/* Countdown Card */}
          <Card className="bg-[#4A3832] border-none shadow-xl rounded-3xl lg:col-span-3">
            <CardContent className="p-8 space-y-6">
              <div className="text-center space-y-4">
              ...
              <div className="mt-8 aspect-[21/9] max-w-3xl mx-auto bg-gradient-to-br from-[#6B5D56] to-[#4A3832] rounded-2xl flex items-center justify-center">
